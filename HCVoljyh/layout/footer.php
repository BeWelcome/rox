...
if ($_SESSION['lang'] != 'fr')
	echo "  <a href=\"", $langurl, "lang=fr\"><img border=0 height=10 src=\"images/fr.gif\" alt=\"Français\" width=16></a>\n";
if ($_SESSION['lang'] != 'eng')
	echo "  <a href=\"", $langurl, "lang=eng\"><img border=0 height=10 src=\"images/en.gif\" alt=\"English\" width=16></a>\n";
if ($_SESSION['lang'] != 'esp')
	echo "  <a href=\"", $langurl, "lang=esp\"><img border=0 height=10 src=\"images/esp.gif\" alt=\"Español\" width=16></a>\n";
if ($_SESSION['lang'] != 'de')
	echo "  <a href=\"", $langurl, "lang=de\"><img border=0 height=10 src=\"images/de.gif\" alt=\"Deutsch\" width=16></a>\n";
if ($_SESSION['lang'] != 'it')
...
if ($_SESSION['lang'] != 'espe')
	echo "  <a href=\"", $langurl, "lang=espe\"><img border=0 height=10 src=\"images/esper.gif\" alt=\"esperanto\" width=16></a>\n";
