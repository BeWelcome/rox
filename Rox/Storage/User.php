 ...
 * User
 *
 * @ORM\Table(name="user", indexes={@ORM\Index(name="user_id", columns={"auth_id"}), @ORM\Index(name="handle", columns={"handle"}), @ORM\Index(name="email", columns={"email"}), @ORM\Index(name="location", columns={"location"})})
 * @ORM\Entity
 */
class User
{
