...
$format = array('short'=>$words->getSilent('DateFormatShort'));
    ...
    ?><h3 class="first" ><a href="blog/tags/Community News for the frontpage"><?php echo $words->getFormatted('CommunityNews') ?> <img src="images/icons/feed.png" alt="<?=$words->get('GetRSSFeed')?>"></a></h3>
                <div class="floatbox">
                    <?php
                    $i=1;
