...
<ul class="floatbox">
    <li class="userpicbox_big float_left"><h4><a href="people/thorgal67"><img src="http://www.bewelcome.org/members/avatar/thorgal67" class="framed float_left" style="height:70px; width: 70px;" alt="Frank" />Frank</a><br /><span class="small"><?php echo $words->get('BoD_RoleOfThorgal67'); ?></span></h4>
    <p>
