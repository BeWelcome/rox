  ...
  <div class="c50l">
    <div class="subcl">
      <!-- Content of left block -->
        <h2><a href="trip">Trips</a></h2>
        Create trips and see where other travellers are headed
        <h2><a href="blog">Blogs</a></h2>
        Create your own blog posts, surf lots of other member blogs
        <h2><a href="chat">Chat</a></h2>
        Talk to the crowd, live on the ajax chat
    </div>
  </div>
...
<!-- [STOP_FASTMENU] -->
        Choose your shipping country to explore the BeWelcome shop. Your country is not in the list? Sorry, our partner spreadshirt doesn't ship to your country.
        <h2><a href="gallery">Gallery</a></h2>
        Upload your pictures, create albums and integrate them in your blog
