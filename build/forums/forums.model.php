...
WHERE `id` = '%d' ",
    ...
    /**
		...
		returns an array
     */
    public function prepareReportList($IdMember, $StatusList)
    { // This retrieve all the reports for the a member or all members
    ...
    /**
		...
		returns and integer
     */
    public function countReportList($IdMember, $StatusList)
    { // This count all the reports for and optional members or all members according to their styatus
...
ORDER BY `posttime` DESC",
    ...
    { // Return the IdContent (IdTrad for the id of the post, according to currently set $this->messageId
        $IdContent = -1;
    ...
    {
        $purifier = (new MOD_htmlpure())->getForumsHtmlPurifier();
