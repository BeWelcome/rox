...
<div class="col-12">
    ...
    <ol>
        ...
        <li><?php echo $words->getFormatted('ForumRulesDiscussionGroupsText8'); ?></li>
        <li><?php echo $words->getFormatted('ForumRulesDiscussionGroupsText9'); ?></li>
    </ol>
    <p><?php echo $words->getFormatted('ForumRulesDiscussionGroupsText10'); ?></p>
