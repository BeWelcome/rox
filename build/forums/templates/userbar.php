...
<div class="list-group mb-3">
    ...
    <?php  if ($this->session->has( "IdMember" )) {
        ...
        if ($this->BW_Right->HasRight("ForumModerator")) { ?>
            ...
            <div class="list-group mb-3">
                <a href="forums/reporttomod/AllActiveReports" class="list-group-item nav-link">All pending reports <span class="badge badge-primary u-rounded-8 u-min-w-20 u-h-20 u-inline-flex u-items-center u-justify-center pull-right"><?php echo $this->_model->countReportList(0,"('Open','OnDiscussion')"); ?></span></a>
            </div>
       <?php }
       if ($this->BW_Right->HasRight("ForumModerator")) { ?>
