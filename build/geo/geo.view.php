        ...
        if ($locations) {
            ...
            foreach ($locations as $location) {
                if (isset($location['name'])) {
                    ...
                    $out .= '<li id="li_'.$location['geonameId'].'" '.$dohide.' onclick="javascript: setMap(\''.$location['geonameId'].'\', \''.$location['lat'].'\',  \''.$location['lng'].'\', \''.$location['zoom'].'\', \''.$location['name'].'\', \''.$location['countryName'].'\', \''.$location['countryCode'].'\', \''.(isset($location['adminName1']) ? $location['adminName1'] : '').'\'); return false;"><a id="href_'.$location['geonameId'].'" onclick="javascript: setMap(\''.$location['geonameId'].'\', \''.$location['lat'].'\',  \''.$location['lng'].'\', \''.$location['zoom'].'\', \''.$location['name'].'\', \''.$location['countryName'].'\', \''.$location['countryCode'].'\', \''.(isset($location['adminName1']) ? $location['adminName1'] : '').'\'); return false;">
                            '.$location['name'].'<br />
