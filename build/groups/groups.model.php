        ...
        if (!empty($order))
        {
            switch ($order)
            {
                ...
                case "namedesc":
                    ...
                    break;
                case "membersasc":
                    $order = "(SELECT SUM(IdMember) FROM membersgroups as mg WHERE IdGroup = groups.id AND Status = 'In') ASC, Name ASC";
                    break;
                case "membersdesc":
                    $order = "(SELECT SUM(IdMember) FROM membersgroups as mg WHERE IdGroup = groups.id AND Status = 'In') DESC, Name ASC";
                    break;
                case "createdasc":
