...
class GroupsBasePage extends PageWithActiveSkin
{
    ...
    protected function teaserContent()
    {
        ...
        ?>
        <div>
        <p class="h2"><a href="forums"><?= $words->get('CommunityDiscussions');?></a> &raquo; <a href="groups/forums"><?= $words->get('Groups');?></a> &raquo; <a href="groups/<?=$this->group->id ?>"><?= htmlspecialchars($this->group->Name, ENT_QUOTES) ?></a></p>
        </div>
        <?php
    }
