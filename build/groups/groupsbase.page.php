...
class GroupsBasePage extends PageWithActiveSkin
{
    ...
    protected function getSubmenuItems()
    {
        ...
        if ($this->group)
        {
            ...
            if ($this->isGroupMember())
            {
                ...
                $items[] = array('relatedgroupsettings', 'groups/'.$group_id.'/relatedgroupsettings', $words->getSilent('GroupSubgroups'));
            }
    ...
    protected function getStylesheets() {
       ...
       $stylesheets[] = 'styles/css/minimal/screen/custom/forums.css?2';
       return $stylesheets;
    }
