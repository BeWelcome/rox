<div id="groups">
    <div>
        ...
        if ($this->search_result)
        {
            ...
            |
            <a class="grey" href="groups/featured?GroupsFeaturedInput={$this->search_terms}&amp;Order={$member_order}&Page={$this->result_page}">Number of Members</a>
            |
            <a class="grey" href="groups/featured?GroupsFeaturedInput={$this->search_terms}&amp;Order={$created_order}&Page={$this->result_page}">Date of creation</a>
HTML;
