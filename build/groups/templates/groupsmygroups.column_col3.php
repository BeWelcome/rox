        ...
        if ($this->search_result)
        {
            foreach($this->search_result as $group_data)
            {
                ...
                <div class="floatbox">
                    ...
                    <h6 class="small"><?= $words->get('GroupsMemberCount', $group_data->getMemberCount()); ?> | <?= count($group_data->getNewMembers()) ; ?> | <?= $words->get('GroupsNewForumPosts', $group_data->getNewForumPosts); ?></h6>
