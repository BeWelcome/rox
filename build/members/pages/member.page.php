    ...
    protected function getSubmenuItems()
    {
        ...
        if ($this->myself) {
            ...
            $tt= array(
                ...
                array('report', "/feedback?IdCategory=2&FeedbackQuestion=" . urlencode( $words->get('profile.report.text')), '<i class="fas fa-fw fa-flag"></i> ' . $words->getSilent('profile.report', $username)),
                array('space', '', '', 'space'),
