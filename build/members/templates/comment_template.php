          ...
          <div class="subcl" >
            ...
            <div class="comment">
                <p class="floatbox">
                  ...
                  <?php if ($this->loggedInMember) :?>
                    <a class="flagbutton" href="members/reportcomment/<?php echo $cc->UsernameToMember; ?>/<?php echo $cc->id;?>" title="<?=$ww->ReportCommentProblem ?>"><img src="images/icons/noun_project_flag.png" alt="<?=$ww->ReportCommentProblem ?>"></a>
                  <?php endif;?>
                </p>
                <p>
                  <em><?=$cc->TextWhere?></em>
