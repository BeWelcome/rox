                ...
                <div class="col-12 col-md-6 col-lg-4 pt-2">
                    <div class="media">
                        <a href="group/<?= $group->id ?>">
                            <img class="groupimg framed mr-1" alt="<?= htmlspecialchars((string) $group->Name, ENT_QUOTES) ?>"
                                 src="<?= ((strlen((string) $group->Picture) > 0) ? "group/thumbimg/{$group->getPKValue()}" : 'images/icons/group.png' ) ;?>">
                        </a>
                        <div class="media-body">
                            <h5><a href="group/<?= $group->id ?>"><?= htmlspecialchars((string) $group->Name, ENT_QUOTES) ?></a></h5>
