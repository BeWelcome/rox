                    ...
                    <div class="comment-bg-<?=$quality?> p-2">
                       <div class="my-1 clearfix">
                           <a href="members/<?=$c->UsernameFromMember?>">
                               <img class="float-left mr-2 profileimg"  src="members/avatar/<?=$c->UsernameFromMember?>/48"  height="48"  width="48"  alt="<?=$c->UsernameFromMember?>" />
                           </a>
                           <div>
                            ...
                            <div class="d-flex d-column w-100">
                                <div>
                                    <a href="<?=PVars::getObj('env')->baseuri."members/".$rel->Username?>"  title="See profile <?=$rel->Username?>">
                                        <img class="float-left profileimg"  src="members/avatar/<?=$rel->Username?>/48"  height="48"  width="48"  alt="Profile" />
                                    </a>
                                </div>
                                <div>
