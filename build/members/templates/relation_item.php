...
<?php if ($myself): ?>
  <span class="float_right">
    <a class="button" href="<?php echo PVars::getObj('env')->baseuri . "members/" . $username . "/relations/delete/".$rel->id; ?>" onclick="return confirm('<?php echo $words->get('Relation_delete_confirmation'); ?>');"><?php echo $words->get('Delete'); ?></a>
  </span>
<? endif; ?>
