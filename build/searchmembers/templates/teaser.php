...
<div id="teaser" class="clearfix">
    ...
    <div id="searchteaser" style="width: 100%;" class="floatbox">
        ...
        <input type="text" size="30" name="Address" id="Address" class="float_left" value="<?=isset($_GET['vars']) ? $_GET['vars'] : $words->getBuffered('searchmembersAllOver');?>"
...
<div class="floatbox" style="padding-top: 10px">
    ...
    */ ?>
    ...
    <form id="changethisorder" style="overflow: visible;">
