...
?>
    <div class="form-group row m-t-2">
        ...
        <div class="col-xs-12 col-md-3 p-a-0"><span class="text-muted small"><?=$words->get('subline_username')?></span></div>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-md-3 p-a-0"><span class="text-muted small">Please choose a strong password. You may use all letters (a-z A-Z), numbers (0-9) and some special characters (# % ! = + - _)</span></div>
        <div class="col-md-2"></div>
    </div>
    ...
    <div class="form-group row m-t-1">
        ...
        <div class="col-xs-12 col-md-3 p-a-0"><span class="text-muted small">Your e-mail address is most important: we will forward the messages and request to this e-mail address</span></div>
        <div class="col-md-2"></div>
    </div>
    ...
    <div class="form-group row m-t-1">
        ...
        <div class="col-xs-12 col-md-3 p-a-0"><span class="text-muted small">Are you able to provide accommodation?</span></div>
        <div class="col-md-2"></div>
    </div>
