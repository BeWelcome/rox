...
<div class="card card-block">
    <div class="row">
        <div class="card-header">
            <h4 class="card-title"><?php echo $words->get('SignupSummary'); ?><small class="pull-right">Step 4/4</small></h4>
            ...
            <div class="col-xs-12 col-md-5">
                ...
                <div class="card card-block">
                    ...
                    <div class="form-group">
                        ...
                        <input <?=(in_array('SignupErrorWrongUsername', $vars['errors']) || in_array('SignupErrorUsernameAlreadyTaken', $vars['errors'])) ? 'type="text"' : 'type="hidden"'?> id="register-username" class="form-control" name="username" placeholder="<?php echo $words->get('SignupUsername'); ?>"
                            <?php
