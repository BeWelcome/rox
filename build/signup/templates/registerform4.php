...
?>
	...
	<ul class="list-group">
		<li class="list-group-item"><?php echo $words->get('SignupName'); ?></li>
	</ul>
	...
	<div class="panel-body">
	   ...
	   <?php endif;
		...
		<div class="form-group">
			...
			<input id="firstname" name="firstname" placeholder="<?php echo $words->get('FirstName'); ?>"
			<?php
		...
		<div class="form-group">
			...
			<input id="secondname" name="secondname" placeholder="<?php echo $words->get('SignupSecondNameOptional'); ?>" 
			<?php
	...
	<!-- Last Name -->
		<div class="form-group">
			...
			<input id="lastname" name="lastname" placeholder="<?php echo $words->get('LastName'); ?>"
			<?php
		...
		<div class="form-group">
			<label for="firstname" class="control-label sr-only"><?php echo $words->get('Name'); ?></label>
			<input type="hidden" id="firstname" name="firstname" placeholder="<?php echo $words->get('SignupCheckEmail'); ?>" 
			<?php
				echo isset($vars['firstname']) ? 'value="'.htmlentities($vars['firstname'], ENT_COMPAT, 'utf-8').'" ' : '';
			?>
			>
			<input type="hidden" id="secondname" name="secondname" placeholder="<?php echo $words->get('SignupCheckEmail'); ?>"
			<?php
				echo isset($vars['secondname']) ? 'value="'.htmlentities($vars['secondname'], ENT_COMPAT, 'utf-8').'" ' : '';
		  	?>
		  	>
		  	<input type="hidden" id="lastname" name="lastname" placeholder="<?php echo $words->get('SignupCheckEmail'); ?>" 
		  	<?php
		...
		<div class="form-group">
			...
			<select name="mothertongue" id="mothertongue" data-placeholder="<?php $words->getBuffered('SignupSelectMotherTongue')?>" placeholder="<?php $words->getBuffered('SignupSelectMotherTongue')?>" class="select2"
  	...
  	<!-- List group: Location -->
  	<ul class="list-group">
		<li class="list-group-item"><?php echo $words->get('Location'); ?></li>
	</ul>
	...
	<?php } ?>
  	...
  	<!-- List group: Feedback -->
  	<ul class="list-group">
		<li class="list-group-item"><?php echo $words->get('SignupFeedback'); ?></li>
	</ul>
