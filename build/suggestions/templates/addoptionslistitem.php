...
echo $this->purifier->purify($layoutbits->truncate_words($suggestion->description, 25)) . '</td>';
if ($discuss) :
    ...
    echo '<td class="details">' . $suggestion->posts . '<br />' . $suggestion->optionsVisibleCount . '</td>';
else :
    echo '<td></td>';
    echo '<td class="details">' . $suggestion->posts . '<br />' . $suggestion->optionsVisibleCount . '</td>';
endif;
