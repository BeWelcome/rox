...
<div class="row">
    ...
    <p><?php echo $words->get('MakingSuggestionsText');?>
    <h3><?php echo $words->get('SuggestionsLifeCycle');?></h3>
    <p><?php echo $words->get('SuggestionsLifeCycleText');?>
    <h3><?php echo $words->get('DecisionMakingProcessDetails');?></h3>
    <p><?php echo $words->get('DecisionMakingProcessDetailsText');?>