...
<input type="hidden" class="validate collect" name="location-longitude[]" id="<?= $location ?>-longitude"
    ...
    <div class="form-group has-feedback col-md-5">
        ...
        if (in_array('TripErrorWrongArrivalFormat###' . $locationRow, $errors)) {
            echo '<span class="alert alert-danger p-x-1 p-y-0"><small>' . $words->get('TripErrorWrongArrivalFormat') . '</small></span>';
        }
        ?>
    </div>
    ...
    <div class="form-group col-md-5">
        ...
        if (in_array('TripErrorWrongDepartureFormat###' . $locationRow, $errors)) {
            echo '<span class="alert alert-danger p-x-1 p-y-0"><small>' . $words->get('TripErrorWrongDepartureFormat') . '</small></span>';
        }
        ?>
    </div>
    <div class="col-md-1"></div>
