...
switch (GetParam("action")) {
	...
	case "update" :
		...
		if (!isset ($rwq->id)) {
			$str = "insert into words(code,Description,IdLanguage,ShortCode) values('" . "FaqQ_" . GetParam("QandA") . "','This is a question for a Faq',0,'en')";
			sql_query($str);
		}
		if (!isset ($rwa->id)) {
			$str = "insert into words(code,Description,IdLanguage,ShortCode) values('" . "FaqA_" . GetParam("QandA") . "','This is an an answer for a Faq',0,'en')";
			sql_query($str);
		}
