...
function DisplayFeedback($tlist,$IdCategory=0) {
	...
	echo '<p><input type="checkbox" id="feedbackUrgent" name="urgent"> <label for="feedbackUrgent">' , ww("FeedBackUrgentQuestion"), "</label></p>";
	if (!IsLoggedIn()) {
	    echo "<h4>", ww("FeedBackEmailNeeded"), "</h4>";
	    echo "<p><input type=\"text\" name=\"Email\" size=\"45\" /></p>";
	} else {
	    echo '<p><input type="checkbox" id="feedbackAnswerneeded" name="answerneeded"> <label for="feedbackAnswerneeded">', ww("FeedBackIWantAnAnswer"), "</label></p>";
	}
	 ?>
