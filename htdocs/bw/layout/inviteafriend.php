...
function DisplayForm($m,$JoinMemberPict="") {
	...
	DisplayHeaderShortUserContent(ww("InviteAFriendPage"),"",""); // Display the header
	...
	if (IsPublic($_SESSION["IdMember"])) {
		 echo "<p>","<textarea name=\"Message\" rows=\"20\" cols=\"80\">",str_replace("<br />","\n",ww("InviteAFriendStandardText","<a href=\"http://www.bewelcome.org/bw/member.php?cid=".$_SESSION["Username"]."\">".$_SESSION["Username"]."</a>")),"</textarea></p>\n";
	}
	else {
		 echo "<p>","<textarea name=\"Message\" rows=\"20\" cols=\"80\">",str_replace("<br />","\n",ww("InviteAFriendTextPrivateProf","<a href=\"http://www.bewelcome.org/bw/member.php?cid=".$_SESSION["Username"]."\">".$_SESSION["Username"]."</a>")),"</textarea></p>\n";
	}
