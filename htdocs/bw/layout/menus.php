...
<?php
  ...
  if (isset($_SESSION['WhoIsOnlineCount'])) {
	    menu_link($link, PVars::getObj('env')->baseuri."online", ww("NbMembersOnline", $_SESSION['WhoIsOnlineCount']), "styles/YAML/images/icon_grey_online.png\" alt=\"onlinemembers\" />");
  }
...
function VolMenu($link = "", $tt = "") {
  ...
  if (HasRight("Words")) {
    ...
    if ($link == "admin/adminwords.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminwords.php")."\" ";
    }
  ...
  if (HasRight("Accepter")) {
    ...
    if ($link == "admin/adminaccepter.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminaccepter.php")."\" ";
    }
    ...
    if ($link == "admin/adminmandatory.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminmandatory.php")."\" ";
    }
    $AccepterScope= RightScope('Accepter');
    if (($AccepterScope == "\"All\"") or ($AccepterScope == "All") or ($AccepterScope == "'All'")) {
       $InScope = " /* All countries */";
  ...
  if (HasRight("Grep")) {
    ...
    if ($link == "admin/admingrep.php") {
      ...
      $res .= " href=\"".bwlink("admin/admingrep.php")."\" ";
    }
  ...
  if (HasRight("Group")) {
    ...
    if ($link == "admin/admingroups.php") {
      ...
      $res .= " href=\"".bwlink("admin/admingroups.php")."\" ";
    }
  ...
  if (HasRight("Flags")) {
    ...
    if ($link == "admin/adminflags.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminflags.php")."\" ";
    }
  ...
  if (HasRight("Rights")) {
    ...
    if ($link == "admin/adminrights.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminrights.php")."\" ";
    }
  ...
  if (HasRight("Logs")) {
    ...
    if ($link == "admin/adminlogs.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminlogs.php")."\" ";
    }
  ...
  if (HasRight("Comments")) {
    ...
    if ($link == "admin/admincomments.php") {
      ...
      $res .= " href=\"".bwlink("admin/admincomments.php")."\" ";
    }
  ...
  if (HasRight("Pannel")) {
    ...
    if ($link == "admin/adminpanel.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminpanel.php")."\" ";
    }
  ...
  if (HasRight("Checker")) {
    ...
    if ($link == "admin/adminchecker.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminchecker.php")."\" ";
    }
  ...
  if (HasRight("MassMail")) {
    ...
    if ($link == "admin/adminmassmails.php") {
      ...
      $res .= " href=\"".bwlink("admin/adminmassmails.php")."\" ";
    }
