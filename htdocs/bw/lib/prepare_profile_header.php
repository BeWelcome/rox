...
if(is_dir(getcwd()."/memberphotos/thumbs")) echo "2. true"; else echo "2. false";
...
if(is_file("/var/www/upload/images/memberphotos/thumbs/wukk_1169999660.square.80x80.jpg")) echo "5. true"; else echo "5. false";
