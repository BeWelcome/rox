...
class Swift_Message_Encoder
{
	 ...
	 * @return string
	 */
	public function base64Encode($data, $chunk=76, $init_chunk=0, $preserve_address=false, $le="\r\n")
	{
		$ret = "";
		$chunk -= 2;
	 ...
	 * @return string
	 */
	public function QPEncode($data, $chunk=76, $init_chunk=0, $preserve_address=false, $le="\r\n")
	{
		$ret = "";
		if ($preserve_address) $data = $this->addressChunk($data);
		else $data = array($data);
