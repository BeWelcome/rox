...
// Check if there is a member with  needmore status allready using this email
		...
		$str = "INSERT INTO `user` ( `auth_id` , `handle` , `email` , `pw` , `active` , `lastlogin` , `location` )
		            VALUES ( NULL , '".$Username."', '" . $Email . "', '', '1', NULL , " . $IdCity . ")";
		sql_query($str);
...
// Hardcoding to be sure of the link
		...
		$text .= "<br /><a href=\"http://www.bewelcome.org/bw/admin/adminaccepter.php\">go to accepting</a>\n";
