...
if ($_SESSION['switchtrans']=='on') {
  ...
  echo "<a href=\"AdminWords.php?showtransarray=1&pagetotranslate=".$pagetotranslate."\" target=new><img border=0 height=10 src=\"images/showtransarray.gif\" alt=\"go to current translation list for ".$_SERVER['PHP_SELF']."\" width=16></a>&nbsp;" ;
}
