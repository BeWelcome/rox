...
$_SYSHCVOL['MYSQLUsername'] = "hcvoltestuser";
$_SYSHCVOL['MYSQLPassword'] = "ba17s90so";
...
$_SYSHCVOL['SiteName'] = "localhost"; // This is the name of the web site 
...
$_SYSHCVOL['FeedbackSenderMail'] = 'feedbackform@' . $_SYSHCVOL['DomainName']; // This is the mail use to send mail to volunteers
