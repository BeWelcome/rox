...
class GroupsForumsNotLoggedInWordCodes extends Rox\Tools\RoxMigration
{
    ...
    public function up()
    {
        ...
        $this->AddWordCode('GroupsNoForumPosts', 'There are no posts in this group yet.', 'Info text shown to a member of the group if there are no posts.');
    ...
    public function down()
    {
        ...
        $this->RemoveWordCode('GroupsNoForumPosts');
