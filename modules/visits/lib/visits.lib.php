...
WHERE
    members.Status='Active' AND DATEDIFF(members.created, now()) <  0 AND membersphotos.IdMember = members.id AND members.id = addresses.IdMember AND addresses.IdCity = g1.geonameid AND g2.geonameid = g1.parentCountryId
GROUP BY
