<?php
    ...
    $this->addRoute('suggestions_approve', 'suggestions/:id:/approve', 'suggestionsController', 'suggestionsApprove');
    ...
    $this->addRoute('suggestions_rank', 'suggestions/:id:/rank', 'suggestionsController', 'suggestionsRank');
