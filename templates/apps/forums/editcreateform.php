...
tinyMCE.init({
    ...
    relative_urls:false,
    convert_urls:false,
    theme_advanced_buttons1: "bold,italic,underline,strikethrough,link,separator,bullist,numlist,blockquote,separator,justifyleft,justifyright,justifycenter,justifyfull,forecolor,backcolor,charmap",
