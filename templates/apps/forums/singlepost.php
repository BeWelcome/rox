<div class="forumspost">
	<div class="forumsauthor">	
		...
		<div class="forumsavatar">
			<img src="http://<?php $BWImageURL=file_get_contents("http://www.bewelcome.org/myphotos.php?PictForMember=".$post->user_handle); echo $BWImageURL; ?>?xs=1" alt="avatar" title="<?php echo $post->user_handle; ?>"  WIDTH=50 HEIGHT=50 />
		</div>
	</div>
