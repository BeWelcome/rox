...
<h2>'.$d->title.'</h2>
<div class="img">
    <img src="gallery/thumbimg?id='.$d->id.'&amp;t=2" alt="image"/>
    <p class="small">'.$d->width.'x'.$d->height.'; '.$d->mimetype.'; '.$imgText['uploaded_by'].': <a href="gallery/show/user/'.$d->user_handle.'">'.$d->user_handle.'</a>.</p>
';
        // download
echo '
    <p class="small"><a href="gallery/img?id='.$d->id.'&amp;s=1"><img src="images/icons/disk.png" alt="'.$imgText['download'].'" title="'.$imgText['download'].'"/></a></p>
';
