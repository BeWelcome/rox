...
<div id="galleryflickr">
    ...
    <p><?php echo $words->getFormatted('galleryFlickrUpload')?> <a href="gallery/flickr"><?php echo $words->getFormatted('galleryFlickrMore')?></a></p>
...
//        $photos_url = $f->urls_getUserPhotos($person['id']);
        ...
        $photos = $f->photos_search(array("tags"=>"be.welcome,bewelcome", "tag_mode"=>"any", "per_page"=>"20"));
