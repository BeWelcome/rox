      ...
      <div id="middle_nav" class="clearfix">
        <div id="nav_sub">
          <ul> 
			...
			<a href="donate">
			<span><?php echo $words->getFormatted('DonateLink'); ?></span></a></li>
            <li id="sub2" class="<?php if ($sub=='list') echo 'active';?>"><a href="donate/list"><span><?php echo $words->getFormatted('DonateList'); ?></span></a></li>
