...
echo		"<li><a href=\"volunteer/trac\" title=\"" . $words->get('VolunteerToolsTipTrac') . "\" >" . $words->get('VolunteerToolsLinkTrac') . "</a><a href=\"http://". $_SESSION['Username'] ."@bevolunteer.org/trac/login\" target =\"blank\" title=\"" . $words->get('VolunteerToolsTipForumExt') . "\" >[ext]</a></li>\n";
echo		"<li><a href=\"volunteer/otrs\" title=\"" . $words->get('VolunteerToolsTipOTRS') . "\" >" . $words->get('VolunteerToolsLinkOTRS') . "</a><a href=\"http://www.bevolunteer.org/otrs\" target =\"blank\" title=\"" . $words->get('VolunteerToolsTipForumExt') . "\" >[ext]</a></li>\n";
