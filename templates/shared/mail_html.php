...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
    ...
    <body style="background-color: #cccccc;font-color: #333;font-size: 12px;line-height: 1.5em;font-family: arial,verdana,sans-serif;margin: 0;padding: 0;">
        <div style="width: 580px;margin: 0;padding: 0 0 2em 0; background-color: #ffffff; background: #ffffff url(<?php
        ...
        <div style="width: 580px; height: 80px; background: #cccccc url(<?php echo PVars::getObj('env')->baseuri;
