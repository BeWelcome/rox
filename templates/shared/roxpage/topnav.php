<ul>
  ...
  <?php if ($logged_in) { ?>
  <li><img src="styles/YAML/images/icon_grey_mail.png" alt="mymessages"/><a href="messages"><?php echo $words->getBuffered('Mymessages'); ?></a><?php echo $words->flushBuffer(); ?></li>
  <li><img src="styles/YAML/images/icon_grey_pref.png" alt="mypreferences"/><a href="mypreferences"><?php echo $words->getBuffered('MyPreferences'); ?></a><?php echo $words->flushBuffer(); ?></li>
