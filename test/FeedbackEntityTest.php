...
*/
    ...
    /**
     * tests the feedback entity class
     *
     * @package    Tests
     * @subpackage EntityTests
     * @author     Fake51
...
class FeedbackEntityTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $f = $this->newF();
        $this->assertEquals(true, $f instanceof Feedback);
        $this->assertEquals(true, $f instanceof RoxEntityBase);
    }

    private function newF()
    {
        return $this->entity_factory->create('Feedback');
    }
}
