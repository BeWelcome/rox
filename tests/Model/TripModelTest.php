...
class TripModelTest extends TestCase
{
    ...
    public function testMultipleLegWithOptionsSelectedReturnsNoError()
    {
        ...
        $leg2 = new SubTrip();
        $leg1->setOptions([SubtripOptionsType::LOOKING_FOR_HOST, SubtripOptionsType::MEET_LOCALS]);
        $leg3 = new SubTrip();
        $leg1->setOptions([SubtripOptionsType::MEET_LOCALS]);
        $leg4 = new SubTrip();
        $trip
    ...
    public function testLegsAreReturnedSorted()
    {
        ...
        $leg3->setDeparture(new DateTime('2021-02-26'));
        $leg4 = new SubTrip();
        $leg4->setArrival(new DateTime('2021-02-28'));
        $leg4->setDeparture(new DateTime('2021-03-01'));
        $trip
            ->addSubtrip($leg1)
            ->addSubtrip($leg2)
            ->addSubtrip($leg3)
        ...
        $tripModel = new TripModel($em);
        $tripModel->orderTripLegs($trip);

        $legs = $trip->getSubtrips();
        $this->assertSame(new DateTIme('2021-01-22'), $legs[0]->getArrival());
        $this->assertSame(new DateTIme('2021-02-22'), $legs[1]->getArrival());
        $this->assertSame(new DateTIme('2021-02-24'), $legs[2]->getArrival());
