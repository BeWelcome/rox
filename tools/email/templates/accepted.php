...
*/
    ...
    /**
     * email sent to new members that have just been accepted
     *
     * @package    Tools
     * @subpackage Email
     * @author     Fake51
     */
class EmailAccepted extends AbstractEmailTemplate
{
    ...
    public function getSubject()
    {
        ...
        return $this->getWords()->get("SignupSubjAccepted", $this->_member->Username);
    }
    ...
    {
        if (!$this->ready_state) return '';
        return $this->getWords()->get("SignupYouHaveBeenAccepted", $this->_member->Username, PVars::getObj('env')->baseuri, PVars::getObj('env')->baseuri . "login");
    }
}
