...
*/
    ...
    /**
     * email sent to members when they request new password
     *
     * @package    Tools
     * @subpackage Email
     * @author     Fake51
     */
class EmailLostPass extends AbstractEmailTemplate
{
    ...
    public function getSubject()
    {
        ...
        return $this->getWords()->get("MemberForgottenDetails", $this->_member->Username);
    }
    ...
    {
        if (!$this->ready_state) return '';
        return $this->getWords()->get("MemberYourDetails", $this->_member->Username, PVars::getObj('env')->baseuri, PVars::getObj('env')->baseuri . "login");
    }
}
