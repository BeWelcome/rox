    ...
    protected function printHTML()
    {
        ...
        <head>
            <link rel="shortcut icon" href="<?php echo PVars::getObj("env")->baseuri ?>favicon.ico" />
						...
						if (empty($page->meta_description)) $page->meta_description=$words->getBuffered("default_meta_description") ;
						echo "  <meta name=\"description\" content=\"",$page->meta_description,"\" />\n" ;
						if (empty($page->meta_keyword)) $page->meta_keyword=$words->getBuffered("default_meta_keyword") ;
						echo "  <meta name=\"keywords\" content=\"",$page->meta_keyword,"\" />\n" ;
						?>
